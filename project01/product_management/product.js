        ...
        templateStr += `
         <tr>
            <th scope="row">${i + 1}</th>
             ...
             <td>${productList[i].catagoryName}</td>
             <td>${productList[i].price}</td>
            <td>${productList[i].quantity}</td>
             <td>
                <button style="margin: 3px; " onclick="deleteItem(${productList[i].id})">Delete</button>
                <button style="margin: 3px; " onclick="edit(${productList[i].id})">Edit</button>
            </td>
        </tr>
        `;
    }
